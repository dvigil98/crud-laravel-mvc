    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-0">
            <a href="#" class="brand-link border-0">
                ...
                <span class="brand-text font-weight-light">SysVentas</span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="/customers" class="nav-link" id="customers">
                                <i class="nav-icon fas fa-th"></i>
                                <p>Clientes</p>
                            </a>
                        </li>
                        <li class="nav-header">Navegación de configuraciones</li>
                        <li class="nav-item">
        ...
        <footer class="main-footer border-0">
            ...
            <strong>Copyright &copy; 2023 <a href="#">SysVentas.</a></strong> Todos los derechos reservados
        </footer>
    </div>

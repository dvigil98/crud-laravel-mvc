                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nombre..." value="{{ $customer->name }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="phone">Teléfono: @error('phone') <small class="text-danger">{{ $message }} *</small>@enderror </label>
                                        <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Teléfono..." value="{{ $customer->phone }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="email">Email: @error('email') <small class="text-danger">{{ $message }} *</small>@enderror </label>
                                        <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email..." value="{{ $customer->email }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="dni">DNI: @error('dni') <small class="text-danger">{{ $message }} *</small>@enderror </label>
                                        <input type="text" name="dni" id="dni" class="form-control @error('dni') is-invalid @enderror" placeholder="DNI..." value="{{ $customer->dni }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="address">Dirección: @error('address') <small class="text-danger">{{ $message }} *</small>@enderror </label>
                                        <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="Dirección..." value="{{ $customer->address }}">
                                    </div>
                                </div>
                            </div>
                        </div>
